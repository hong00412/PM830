...
// todo.1 자신이 가장 좋아하는 숫자를 favorNumber 변수에 담아 자료형태 check.
function numberTypeof() {
    var favorNumber = 2;

    console.log(typeof(favorNumber) + ' data = ' + favorNumber);
}

// todo.2 자신의 영어 이름을 engName 변수에 담아 자료형 check
function textTypeof() {
    var engName = 'Eunbi';
    console.log(typeof(engName) + ' data = ' + engName);
}

// todo.3 현재 자신이 춥다, 아니다를 cold 변수에 담아 자료형 check
function check1() {
    var cold = true;
